...
public class FileReaderWriteriOSAPIDAO extends EgovAbstractDAO{
    ...
    public List<?> selectFileInfoList(FileReaderWriteriOSAPIVO vo) throws Exception{
    	return list("fileReaderWriteriOSAPIDAO.selectFileInfoList", vo);
    }
    ...
    public FileReaderWriteriOSAPIVO selectFileInfo(FileReaderWriteriOSAPIVO vo) throws Exception{
    	return (FileReaderWriteriOSAPIVO) select("fileReaderWriteriOSAPIDAO.selectFileInfo", vo);
    }
