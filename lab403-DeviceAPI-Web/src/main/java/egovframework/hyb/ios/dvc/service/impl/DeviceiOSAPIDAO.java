...
public class DeviceiOSAPIDAO extends EgovAbstractDAO {
    ...
    public DeviceiOSAPIVO selectDeviceInfo(DeviceiOSAPIVO vo) throws Exception {
        return (DeviceiOSAPIVO) select("deviceiOSAPIDAO.selectDeviceInfo", vo);
    }
    ...
    public List<?> selectDeviceInfoList(DeviceiOSAPIVO vo) throws Exception {
        return list("deviceiOSAPIDAO.selectDeviceInfoList", vo);
    }
    ...
    public int selectDeviceInfoListTotCnt(DeviceiOSAPIVO vo) {
        return (Integer)select("deviceiOSAPIDAO.selectDeviceInfoListTotCnt", vo);
    }
