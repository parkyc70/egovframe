...
public class NetworkiOSAPIDAO extends EgovAbstractDAO {
    ...
    public NetworkiOSAPIVO selectNetworkInfo(NetworkiOSAPIVO vo) throws Exception {
        return (NetworkiOSAPIVO) select("networkiOSAPIDAO.selectNetworkInfo", vo);
    }
	 ...
	 * @exception Exception
	 */
    public List<?> selectNetworkInfoList(NetworkiOSAPIDefaultVO searchNetworkVO) throws Exception {
        return list("networkiOSAPIDAO.selectNetworkInfoList", searchNetworkVO);
    	//return null;
    }
	 ...
	 * @exception
	 */
    public int selectNetworkInfoListTotCnt(NetworkiOSAPIDefaultVO searchVO) {
        return (Integer)select("networkAPIDAO.selectNetworkInfoListTotCnt", searchVO);
    }
