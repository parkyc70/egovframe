...
public interface EgovNetworkiOSAPIService {
	 ...
	 * @exception Exception
	 */
    List<?> selectNetworkInfoList(NetworkiOSAPIDefaultVO searchNetworkVO) throws Exception;
    /**
	 * 네트워크 정보 총 갯수를 조회한다.
	 ...
	 * @exception
	 */
    int selectNetworkInfoListTotCnt(NetworkiOSAPIDefaultVO searchNetworkVO);
