...
public class AcceleratoriOSAPIDAO extends EgovAbstractDAO {
    ...
    public AcceleratoriOSAPIVO selectAcceleratorInfo(AcceleratoriOSAPIVO vo) throws Exception {
        return (AcceleratoriOSAPIVO) select("acceleratoriOSAPIDAO.selectAcceleratorInfo", vo);
    }
    ...
    public List<?> selectAcceleratorInfoList(AcceleratoriOSAPIDefaultVO searchVO) throws Exception {
        return list("acceleratoriOSAPIDAO.selectAcceleratorInfoList", searchVO);
    }
    ...
    public int selectAcceleratorInfoListTotCnt(AcceleratoriOSAPIDefaultVO searchVO) {
        return (Integer)select("acceleratoriOSAPIDAO.selectAcceleratorInfoListTotCnt", searchVO);
    }
