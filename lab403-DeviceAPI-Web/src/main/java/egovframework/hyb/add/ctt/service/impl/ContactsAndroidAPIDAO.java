...
public class ContactsAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public List<?> selectFileInfoList(ContactsAndroidAPIVO vo) throws Exception {
        return list("contactsAndroidAPIDAO.selectContactInfoList", vo);
    }
    ...
    public ContactsAndroidAPIVO selectContactsInfo(ContactsAndroidAPIVO vo)
            throws Exception {
        return (ContactsAndroidAPIVO) select(
