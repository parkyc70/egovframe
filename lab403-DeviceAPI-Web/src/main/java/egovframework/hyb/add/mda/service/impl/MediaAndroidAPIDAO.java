...
public class MediaAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public MediaAndroidAPIFileVO selectMediaInfoDetail(MediaAndroidAPIVO vo) throws Exception {
        return (MediaAndroidAPIFileVO)select("mediaAndroidAPIDAO.selectMediaInfoDetail", vo);
    }
    ...
    public List<?> selectMediaInfoList(MediaAndroidAPIVO searchVO) throws Exception {
        return list("mediaAndroidAPIDAO.selectMediaInfoList", searchVO);
    }
    ...
    public MediaAndroidAPIFileVO selectMediaFileInfo(MediaAndroidAPIFileVO vo) throws Exception {
        return (MediaAndroidAPIFileVO)select("mediaAndroidAPIDAO.selectMediaFileInfo", vo);
    }
}
