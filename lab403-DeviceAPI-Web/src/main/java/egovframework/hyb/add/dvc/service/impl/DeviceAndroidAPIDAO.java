...
public class DeviceAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public DeviceAndroidAPIVO selectDeviceInfo(DeviceAndroidAPIVO vo) throws Exception {
        return (DeviceAndroidAPIVO) select("deviceAndroidAPIDAO.selectDeviceInfo", vo);
    }
    ...
    public List<?> selectDeviceInfoList(DeviceAndroidAPIDefaultVO searchVO) throws Exception {
        return list("deviceAndroidAPIDAO.selectDeviceInfoList", searchVO);
    }
    ...
    public int selectDeviceInfoListTotCnt(DeviceAndroidAPIDefaultVO searchVO) {
        return (Integer)select("deviceAndroidAPIDAO.selectDeviceInfoListTotCnt", searchVO);
    }
