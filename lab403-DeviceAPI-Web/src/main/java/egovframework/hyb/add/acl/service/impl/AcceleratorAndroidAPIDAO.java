...
public class AcceleratorAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public AcceleratorAndroidAPIVO selectAcceleratorInfo(AcceleratorAndroidAPIVO vo) throws Exception {
        return (AcceleratorAndroidAPIVO) select("acceleratorAndroidAPIDAO.selectAcceleratorInfo", vo);
    }
    ...
    public List<?> selectAcceleratorInfoList(AcceleratorAndroidAPIDefaultVO searchVO) throws Exception {
        return list("acceleratorAndroidAPIDAO.selectAcceleratorInfoList", searchVO);
    }
    ...
    public int selectAcceleratorInfoListTotCnt(AcceleratorAndroidAPIDefaultVO searchVO) {
        return (Integer)select("acceleratorAndroidAPIDAO.selectAcceleratorInfoListTotCnt", searchVO);
    }
