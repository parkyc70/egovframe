...
public class CameraAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public CameraAndroidAPIVO selectCameraPhotoAlbumInfo(CameraAndroidAPIVO vo) throws Exception {
        return (CameraAndroidAPIVO)select("cameraAndroidAPIDAO.selectCameraPhotoAlbumInfo", vo);
    }
    ...
    public List<?> selectCameraPhotoAlbumInfoList(CameraAndroidAPIDefaultVO searchVO) throws Exception {
        return list("cameraAndroidAPIDAO.selectCameraPhotoAlbumInfoList", searchVO);
    }
    ...
    public CameraAndroidAPIFileVO selectImageFileInfo(CameraAndroidAPIFileVO vo) throws Exception {
        return (CameraAndroidAPIFileVO)select("cameraAndroidAPIDAO.selectImageFileInfo", vo);
    }
    ...
    public CameraAndroidAPIFileVO selectPhotoAlbumPhotoSj(CameraAndroidAPIFileVO vo) throws Exception {
        return (CameraAndroidAPIFileVO)select("cameraAndroidAPIDAO.selectCameraPhotoAlbumPhotoSj", vo);
    }
}
