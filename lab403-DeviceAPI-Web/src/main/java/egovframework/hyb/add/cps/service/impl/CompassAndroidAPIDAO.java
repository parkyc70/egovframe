...
public class CompassAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public CompassAndroidAPIVO selectCompassInfo(CompassAndroidAPIVO vo) throws Exception {
        return (CompassAndroidAPIVO) select("compassAndroidAPIDAO.selectCompassInfo", vo);
    }
    ...
    public List<?> selectCompassInfoList(CompassAndroidAPIDefaultVO searchVO) throws Exception {
        return list("compassAndroidAPIDAO.selectCompassInfoList", searchVO);
    }
    ...
    public int selectCompassInfoListTotCnt(CompassAndroidAPIDefaultVO searchVO) {
        return (Integer)select("compassAndroidAPIDAO.selectCompassInfoListTotCnt", searchVO);
    }
