...
public class NetworkAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public NetworkAndroidAPIVO selectNetworkInfo(NetworkAndroidAPIVO vo) throws Exception {
        return (NetworkAndroidAPIVO) select("networkAndroidAPIDAO.selectNetworkInfo", vo);
    }
    ...
    public List<?> selectNetworkInfoList(NetworkAndroidAPIDefaultVO searchNetworkVO) throws Exception {
        return list("networkAndroidAPIDAO.selectNetworkInfoList", searchNetworkVO);
        //return null;
    }
    ...
    public int selectNetworkInfoListTotCnt(NetworkAndroidAPIDefaultVO searchVO) {
        return (Integer)select("networkAPIDAO.selectNetworkInfoListTotCnt_S", searchVO);
    }
