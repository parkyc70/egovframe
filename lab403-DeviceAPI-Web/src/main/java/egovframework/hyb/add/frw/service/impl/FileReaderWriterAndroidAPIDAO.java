...
public class FileReaderWriterAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public List<?> selectFileInfoList(FileReaderWriterAndroidAPIVO vo)
            throws Exception {
        return list("fileReaderWriterAndroidAPIDAO.selectFileInfoList", vo);
    }
    ...
    public FileReaderWriterAndroidAPIVO selectFileInfo(
        ...
        return (FileReaderWriterAndroidAPIVO) select(
