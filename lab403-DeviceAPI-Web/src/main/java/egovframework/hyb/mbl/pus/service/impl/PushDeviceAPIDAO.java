...
public class PushDeviceAPIDAO extends EgovAbstractDAO {
    ...
    public List<?> selectPushDeviceList(PushDeviceAPIVO searchVO) throws Exception {
        return list("pushDeviceAPIDAO.selectPushDeviceList", searchVO);
    }
    ...
    public PushDeviceAPIVO selectPushDevice(PushDeviceAPIVO vo) throws Exception {
        return (PushDeviceAPIVO) select("pushDeviceAPIDAO.selectPushDevice", vo);
    }
    ...
    public List<?> selectPushMessageList(PushDeviceAPIVO vo) throws Exception {
        return list("pushDeviceAPIDAO.selectPushMessageList", vo);
    }
