...
<%--
  Class Name : mode-page1.jsp
  Description :  UX List component
  Modification Information

      수정일         수정자           수정내용
    -------------    --------    ---------------------
     2012.08.22    박지민          최초 생성
    ...
    <body> 
        ...
        <div data-role="page">
            ...
            <div data-role="header" data-position="inline" data-theme="b">
                ...
                <a href="<c:url value="/guide/components/list/checked.do"/>" data-icon="back" class="ui-btn-right" data-ajax="false">Back</a>
                ...
                <div data-role="navbar" role="navigation">
                    <ul>
                        <li><a href="#" data-rel="back" data-icon="star">Checked List에서 자세히 보기를 누르셨습니다.</a></li>                        
                    </ul>
                </div>                  
            </div>  
            <!-- header end -->
