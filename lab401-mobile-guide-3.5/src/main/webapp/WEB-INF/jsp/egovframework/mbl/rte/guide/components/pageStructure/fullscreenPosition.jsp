...
<%--
  Class Name : fullscreenPosition.jsp
...
<html lang="kr"> 
    ...
    <body>
        ...
        <!-- page start -->
		<div data-role="page" class="type-index" data-fullscreen="true">
		
            <!-- header start -->
            <div data-role="header" data-theme="z"  data-position="fixed"  class="egovBarHeader">
